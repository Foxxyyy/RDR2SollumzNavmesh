...
_import_export_current_game = SollumzGame.RDR
...
SOLLUMZ_UI_NAMES = {
    ...
    SollumType.NAVMESH_COVER_POINT_GROUP: "NavMesh Point Group",
    SollumType.NAVMESH_COVER_POINT: "NavMesh Point",
